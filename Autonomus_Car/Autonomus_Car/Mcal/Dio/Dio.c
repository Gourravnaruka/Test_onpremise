 ...
 * Dio.c
 *
 * Created: 06/07/2022 10:34:13 pm
 *  Author: Ahmed
 */ 
...
u8 M_Dio_PinRead(u8 Local_u8_Num)
{
	...
	switch(Local_u8_Port)
	{
		case 1: Local_u8_PinRead = GetBit(PINA,Local_u8_Pin); break;
		case 2: Local_u8_PinRead = GetBit(PINB,Local_u8_Pin); break;
		case 3: Local_u8_PinRead = GetBit(PINC,Local_u8_Pin); break;
		case 4: Local_u8_PinRead = GetBit(PIND,Local_u8_Pin); break;
		default:                                              break;
	}
...
// function to set mode of a port
